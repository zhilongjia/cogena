...
`heatmapCluster` is developed to show the co-expression of differentially expressed genes. Based on Figure 2, it is obvious to know 
...
while usually the default will be fine.
