...
#Always make the number as charactor, please!
...
#The values shown in Figure 1. is the -log2 (p-values).
#Always make the number as charactor, please!
...
6. The correlation among one cluster could be shown via `corInCluster`. see Figure 3.
